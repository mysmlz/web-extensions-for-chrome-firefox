...
function elementsClassSwitch(elements, elementClass, flag) {
    if (flag) {
        elements.forEach(function (element) { return element === null || element === void 0 ? void 0 : element.classList.add(elementClass); });
    }
    else {
        elements.forEach(function (element) { return element === null || element === void 0 ? void 0 : element.classList.remove(elementClass); });
    }
}
